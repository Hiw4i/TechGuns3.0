...
import com.tuchguns.tuchguns3.TGConfig;
import com.tuchguns.tuchguns3.TuchGuns3;
import com.tuchguns.tuchguns3.entity.BulletProjectile;
...
public class GenericGunItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        tooltip.accept(Component.translatable("tooltip." + TuchGuns3.MODID + ".gun.damage",
                String.format("%.1f", effectiveDamage())).withStyle(ChatFormatting.RED));
        tooltip.accept(Component.translatable("tooltip." + TuchGuns3.MODID + ".gun.magazine",
                stats.magazineSize(), ammoId).withStyle(ChatFormatting.GRAY));
        tooltip.accept(Component.translatable("tooltip." + TuchGuns3.MODID + ".gun.loaded",
                loadedRounds(stack), stats.magazineSize()).withStyle(ChatFormatting.YELLOW));
        tooltip.accept(Component.translatable("tooltip." + TuchGuns3.MODID + ".gun.range",
